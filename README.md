...
![Version: 15.5.23](https://img.shields.io/badge/Version-15.5.23-informational?style=flat-square) ![AppVersion: 16.4.0](https://img.shields.io/badge/AppVersion-16.4.0-informational?style=flat-square)
...
| image.tag | string | `"16.4.0-debian-12-r2"` |  |
| image.digest | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.pullSecrets | list | `[]` |  |
| image.debug | bool | `false` |  |
...
| primary.preInitDb.scripts | object | `{}` |  |
| primary.preInitDb.scriptsConfigMap | string | `""` |  |
| primary.preInitDb.scriptsSecret | string | `""` |  |
...
| readReplicas.pdb.create | bool | `true` |  |
| readReplicas.pdb.minAvailable | string | `""` |  |
| readReplicas.pdb.maxUnavailable | string | `""` |  |
...
| metrics.image.tag | string | `"0.15.0-debian-12-r39"` |  |
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| secrets.name | string | `"myminio-env-configuration"` |  |
| secrets.accessKey | string | `"minio"` |  |
| secrets.secretKey | string | `"minio123"` |  |
| tenant.name | string | `"myminio"` |  |
| tenant.image.repository | string | `"quay.io/minio/minio"` |  |
...
| https://repository.securitycompass.com/artifactory/sde-helm-dev | pas | 2.0.6 |
| https://repository.securitycompass.com/artifactory/sde-helm-dev | sc-datastore | 1.0.14 |
| https://repository.securitycompass.com/artifactory/sde-helm-dev | sc-jitt | 2024.4.3 |
| https://repository.securitycompass.com/artifactory/sde-helm-dev | sc-library | 1.1.5 |
| https://repository.securitycompass.com/artifactory/sde-helm-dev | sc-mail | 0.1.18 |
...
| sde.secretKey | string | `"aRandomEncryptionString"` |  |
| sde.superuserEmail | string | `"sde-superuser@sdelements.com"` |  |
| sde.superuserPassword | string | `"thePasswordForTheDefaultWebSuperUser"` |  |
| sde.jwtSecret | string | `"superSecretPassword"` |  |
| sde.defaultFromEmail | string | `"SDElements <noreply@securitycompass.com>"` |  |
| sde.defaultOrg | string | `"default"` |  |
| sde.feedbackEmail | string | `"sdesupport@securitycompass.com"` |  |
| sde.supportEmail | string | `"sdesupport@securitycompass.com"` |  |
| sde.systemAdminEmail | string | `"default@example.com"` |  |
| sde.fqdn | string | `"example.com"` |  |
| sde.databaseKeepAmount | int | `100` |  |
| sde.enableJITT | bool | `false` |  |
| sde.gainsight.enabled | bool | `false` |  |
| sde.codeScanning.github | object | `{}` |  |
| sde.codeScanning.gitlab | object | `{}` |  |
...
| global.imageRegistryFormat | string | `"%s/sde-docker-%s/%s/%s:%s"` |  |
| global.imageRegistryUsername | string | `"acmecorp"` |  |
| global.imageRegistryPassword | string | `"myPassword"` |  |
| global.imageOrganization | string | `"prod"` |  |
| global.imageSource | string | `"sde"` |  |
| global.imagePullPolicy | string | `"IfNotPresent"` |  |
| global.imagePullSecrets[0] | string | `"security-compass-secret"` |  |
| global.networkIsolation | string | `"none"` |  |
...
| global.thirdPartyCACertificates.enabled | bool | `false` |  |
| global.upgradeToPostgres16 | bool | `true` |  |
| global.broker.adminVhost | string | `"rabbit"` |  |
| global.sharedStorage.bucketName | string | `"bucket-name"` |  |
| global.sharedStorage.s3Url | string | `"https://my-bucket.s3.us-west-2.amazonaws.com/"` |  |
| global.sharedStorage.s3BucketPath | string | `"/path/to/storage/in/bucket/"` |  |
| global.sharedStorage.s3AccessKey | string | `"accesskey"` |  |
| global.sharedStorage.s3SecretKey | string | `"secretKey"` |  |
| global.sharedStorage.region | string | `"us-east-1"` |  |
| global.datastore | object | `{}` |  |
...
| global.pas.sharedStorage.accessKeyIdSecretKey | string | `"S3_ACCESS_KEY"` |  |
| global.pas.sharedStorage.secretAccessKeySecretKey | string | `"S3_SECRET_KEY"` |  |
| global.pas.datastore | object | `{}` |  |
| web.customError | object | `{}` |  |
| web.replicas | int | `1` |  |
| web.readinessProbe.enabled | bool | `true` |  |
| web.resources.requests.cpu | string | `"10m"` |  |
| web.resources.requests.memory | string | `"128Mi"` |  |
| web.resources.limits.memory | string | `"2048Mi"` |  |
| sc-jitt.replicas | int | `1` |  |
| sc-jitt.resources.requests.cpu | string | `"10m"` |  |
| sc-jitt.resources.requests.memory | string | `"128Mi"` |  |
| sc-jitt.resources.limits.memory | string | `"2048Mi"` |  |
| rabbitmq.enabled | bool | `true` |  |
| rabbitmq.nameOverride | string | `"broker"` |  |
| rabbitmq.commonLabels."app.kubernetes.io/part-of" | string | `"{{ include \"library.name\" . }}"` |  |
| rabbitmq.commonLabels.name | string | `"{{ include \"library.trimmedName\" . }}-broker"` |  |
| rabbitmq.image.repository | string | `"sde-docker-prod/bitnami/rabbitmq"` |  |
| rabbitmq.image.tag | string | `"3.13.7-debian-12-r2"` |  |
| rabbitmq.persistence.enabled | bool | `true` |  |
| rabbitmq.persistence.existingClaim | string | `"{{ include \"library.trimmedName\" . }}-broker-volume-claim"` |  |
| rabbitmq.pdb.create | bool | `false` |  |
| rabbitmq.pdb.minAvailable | int | `1` |  |
| rabbitmq.pdb.maxUnavailable | string | `""` |  |
| rabbitmq.loadDefinition.enabled | bool | `true` |  |
| rabbitmq.loadDefinition.existingSecret | string | `"{{ include \"library.trimmedName\" . }}-rabbitmq-load-definition"` |  |
| rabbitmq.auth.username | string | `"rabbit"` |  |
| rabbitmq.auth.password | string | `"myrabbitmqpassword"` |  |
| rabbitmq.extraConfiguration | string | `"default_vhost = {{ .Values.global.broker.adminVhost }}\nmanagement.listener.ip = {{ ternary \"::\" \"0.0.0.0\" (has \"IPv6\" (default (list \"IPv4\") .Values.global.ipFamilies)) }}"` |  |
| rabbitmq.initContainers[0].name | string | `"config-init"` |  |
| rabbitmq.initContainers[0].image | string | `"{{ printf .Values.global.imageRegistryFormat .Values.global.imageRegistry .Values.global.imageOrganization (default .Values.global.imageSource .Values.global.initImageSource) \"busybox\" \"1.36\" }}"` |  |
| rabbitmq.initContainers[0].volumeMounts[0].name | string | `"custom-cfg"` |  |
| rabbitmq.initContainers[0].volumeMounts[0].mountPath | string | `"/config"` |  |
| rabbitmq.initContainers[0].command[0] | string | `"sh"` |  |
| rabbitmq.initContainers[0].command[1] | string | `"-c"` |  |
| rabbitmq.initContainers[0].command[2] | string | `"{{ printf \"echo {inet6, %v}. > /config/erl_inetrc\" (has \"IPv6\" (default (list \"IPv4\") .Values.global.ipFamilies)) }}"` |  |
| rabbitmq.extraVolumes[0].name | string | `"custom-cfg"` |  |
| rabbitmq.extraVolumes[0].emptyDir | object | `{}` |  |
| rabbitmq.extraVolumeMounts[0].name | string | `"custom-cfg"` |  |
| rabbitmq.extraVolumeMounts[0].mountPath | string | `"/config"` |  |
| rabbitmq.extraEnvVars[0].name | string | `"RABBITMQ_SERVER_ADDITIONAL_ERL_ARGS"` |  |
| rabbitmq.extraEnvVars[0].value | string | `"-kernel inetrc '/config/erl_inetrc' -proto_dist {{ ternary \"inet6_tcp\" \"inet_tcp\" (has \"IPv6\" (default (list \"IPv4\") .Values.global.ipFamilies)) }}"` |  |
| rabbitmq.extraEnvVars[1].name | string | `"RABBITMQ_CTL_ERL_ARGS"` |  |
| rabbitmq.extraEnvVars[1].value | string | `"-proto_dist {{ ternary \"inet6_tcp\" \"inet_tcp\" (has \"IPv6\" (default (list \"IPv4\") .Values.global.ipFamilies)) }}"` |  |
| rabbitmq.resources.requests.cpu | string | `"200m"` |  |
| rabbitmq.resources.requests.memory | string | `"256Mi"` |  |
| rabbitmq.resources.limits.memory | string | `"2048Mi"` |  |
| postgresql.enabled | bool | `true` |  |
| postgresql.nameOverride | string | `"database"` |  |
| postgresql.commonLabels.name | string | `"{{ include \"library.trimmedName\" . }}-database"` |  |
| postgresql.postgresqlDataDir | string | `"/bitnami/postgresql/pgdata"` |  |
| postgresql.postgresqlDatabase | string | `"postgres"` |  |
| postgresql.containerPorts.postgresql | int | `5432` |  |
| postgresql.auth.username | string | `"sde"` |  |
| postgresql.auth.password | string | `"mydatabasepassword"` |  |
...
| postgresql.metrics.image.repository | string | `"sde-docker-prod/bitnami/postgres-exporter"` |  |
| postgresql.metrics.image.tag | string | `"0.12.0-debian-11-r84"` |  |
| postgresql.metrics.enabled | bool | `false` |  |
| postgresql.metrics.serviceMonitor.enabled | bool | `false` |  |
| postgresql.primary.initContainers[0].name | string | `"shared-init"` |  |
| postgresql.primary.initContainers[0].image | string | `"registry1.dso.mil/ironbank/security-compass/sd-elements/common-init:2024.3.5-9.4-003"` |  |
| postgresql.primary.initContainers[0].env[0].name | string | `"POSTGRES_UPGRADE"` |  |
| postgresql.primary.initContainers[0].env[0].value | string | `"{{ ternary \"true\" \"false\" (or ( .Values.global.upgradeToPostgres16 ) ( eq ( .Values.global.upgradeToPostgres16 | toString ) \"<nil>\" )) }}"` |  |
| postgresql.primary.initContainers[0].env[1].name | string | `"PGUSER"` |  |
| postgresql.primary.initContainers[0].env[1].value | string | `"{{ .Values.primary.initdb.user }}"` |  |
| postgresql.primary.initContainers[0].env[2].name | string | `"POSTGRES_INITDB_ARGS"` |  |
| postgresql.primary.initContainers[0].env[2].value | string | `"{{ printf \"-U %s\" .Values.primary.initdb.user }}"` |  |
| postgresql.primary.initContainers[0].env[3].name | string | `"PGDATA"` |  |
| postgresql.primary.initContainers[0].env[3].value | string | `"/bitnami/postgresql/data/pgdata"` |  |
| postgresql.primary.initContainers[0].env[4].name | string | `"PGDATATMP"` |  |
| postgresql.primary.initContainers[0].env[4].value | string | `"/var/lib/postgresql/16/data/pg16data"` |  |
| postgresql.primary.initContainers[0].volumeMounts[0].mountPath | string | `"/bitnami/postgresql/data"` |  |
| postgresql.primary.initContainers[0].volumeMounts[0].name | string | `"data"` |  |
| postgresql.primary.initContainers[0].volumeMounts[1].mountPath | string | `"/var/lib/postgresql/16/data"` |  |
| postgresql.primary.initContainers[0].volumeMounts[1].name | string | `"empty-dir-init"` |  |
| postgresql.primary.initContainers[0].resources.requests.ephemeral-storage | string | `"1Gi"` |  |
| postgresql.primary.initContainers[0].resources.limits.ephemeral-storage | string | `"50Gi"` |  |
| postgresql.primary.extraVolumes[0].name | string | `"empty-dir-init"` |  |
| postgresql.primary.extraVolumes[0].emptyDir | object | `{}` |  |
| postgresql.primary.extendedConfiguration | string | `"jit = on\nlog_min_duration_statement = 60000"` |  |
| postgresql.primary.pdb.create | bool | `false` |  |
| postgresql.primary.pdb.minAvailable | int | `1` |  |
| postgresql.primary.pdb.maxUnavailable | string | `""` |  |
| postgresql.primary.lifecycleHooks.preStop.exec.command[0] | string | `"bash"` |  |
| postgresql.primary.lifecycleHooks.preStop.exec.command[1] | string | `"-c"` |  |
| postgresql.primary.lifecycleHooks.preStop.exec.command[2] | string | `"cp /opt/bitnami/postgresql/conf/*.conf ${POSTGRESQL_VOLUME_DIR}/pgdata/ ; sed -i 's/pgaudit.*//g;s/.*preload.*//g;s/include_dir.*//g' ${POSTGRESQL_VOLUME_DIR}/pgdata/postgresql.conf"` |  |
...
| postgresql.primary.volumePermissions.enabled | bool | `false` |  |
| postgresql.primary.volumePermissions.image.repository | string | `"sde-docker-dev/bitnami/bitnami-shell"` |  |
| postgresql.primary.volumePermissions.image.tag | string | `"11-debian-11-r109"` |  |
...
| postgresql.primary.initdb.scripts."init-postgres.sql" | string | `"ALTER USER \"sde\" with SUPERUSER;\n"` |  |
| postgresql.primary.extraEnvVars[0].name | string | `"POSTGRESQL_USERNAME"` |  |
| postgresql.primary.extraEnvVars[0].value | string | `"sde"` |  |
| postgresql.primary.persistence.enabled | bool | `true` |  |
| postgresql.primary.persistence.existingClaim | string | `"{{ include \"library.trimmedName\" . }}-db-volume-claim"` |  |
| postgresql.primary.persistence.size | string | `"30Gi"` |  |
...
| sc-mail.config.mailFrom | string | `"noreply@securitycompass.com"` |  |
| sc-mail.resources.requests.cpu | string | `"10m"` |  |
| sc-mail.resources.requests.memory | string | `"128Mi"` |  |
| sc-mail.resources.limits.memory | string | `"1024Mi"` |  |
| worker.synchronous.lowPriority.compositeApi | bool | `true` |  |
...
| worker.synchronous.lowPriority.resources.requests.cpu | string | `"100m"` |  |
| worker.synchronous.lowPriority.resources.requests.memory | string | `"1024Mi"` |  |
| worker.synchronous.lowPriority.resources.limits.memory | string | `"8192Mi"` |  |
...
| worker.synchronous.highPriority.resources.requests.cpu | string | `"100m"` |  |
| worker.synchronous.highPriority.resources.requests.memory | string | `"1024Mi"` |  |
| worker.synchronous.highPriority.resources.limits.memory | string | `"8192Mi"` |  |
...
| worker.asynchronous.lowPriority.resources.requests.cpu | string | `"50m"` |  |
| worker.asynchronous.lowPriority.resources.requests.memory | string | `"275Mi"` |  |
| worker.asynchronous.lowPriority.resources.limits.memory | string | `"8192Mi"` |  |
...
| worker.asynchronous.mediumPriority.resources.requests.cpu | string | `"50m"` |  |
| worker.asynchronous.mediumPriority.resources.requests.memory | string | `"275Mi"` |  |
| worker.asynchronous.mediumPriority.resources.limits.memory | string | `"8192Mi"` |  |
| reporting.replicas | int | `1` |  |
| reporting.resources.requests.cpu | string | `"100m"` |  |
| reporting.resources.requests.memory | string | `"256Mi"` |  |
| reporting.resources.limits.memory | string | `"8192Mi"` |  |
| sc-datastore.replicas | int | `1` |  |
| sc-datastore.clientPassword | string | `"mySuperDatastorePass"` |  |
| sc-datastore.pdb.create | bool | `false` |  |
| sc-datastore.pdb.minAvailable | int | `1` |  |
| sc-datastore.pdb.maxUnavailable | string | `""` |  |
| sc-datastore.resources.requests.cpu | string | `"10m"` |  |
| sc-datastore.resources.requests.memory | string | `"128Mi"` |  |
| sc-datastore.resources.limits.memory | string | `"4096Mi"` |  |
| trendReporting.enabled | bool | `true` |  |
| job.enabled | bool | `true` |  |
| job.enableRandomStartDelay | bool | `false` |  |
| job.randomStartDelayRange | string | `"1-600"` |  |
| job.resources.requests.cpu | string | `"100m"` |  |
| job.resources.requests.memory | string | `"128Mi"` |  |
| job.resources.limits.memory | string | `"8192Mi"` |  |
| job.specifications.database-backup.randomizedScheduling.enabled | bool | `false` |  |
| job.specifications.database-backup.randomizedScheduling.minutesBetweenRuns | int | `20` |  |
...
| job.specifications.database-backup.resources.requests.cpu | string | `"500m"` |  |
| job.specifications.database-backup.resources.requests.memory | string | `"512Mi"` |  |
| job.specifications.trend-reporting.imageName | string | `"trend-reporting"` |  |
| job.specifications.trend-reporting.imageTag | string | `"2024.4.0"` |  |
| job.specifications.trend-reporting.schedule | string | `"35 3 * * *"` |  |
| job.specifications.trend-reporting.command[0] | string | `"/bin/sh"` |  |
| job.specifications.trend-reporting.uid | int | `100` |  |
| job.specifications.trend-reporting.gid | int | `100` |  |
| job.specifications.trend-reporting.fsgid | int | `100` |  |
| job.specifications.trend-reporting.args[0] | string | `"-c"` |  |
| job.specifications.trend-reporting.args[1] | string | `"python /app/dbt_wrapper.py run-operation index_statistics; python /app/dbt_wrapper.py snapshot && python /app/dbt_wrapper.py run"` |  |
...
| job.specifications.refresh-task-relevance.schedule | string | `"26 5 * * *"` |  |
...
| job.specifications.refresh-task-relevance.args[0] | string | `"refresh_task_relevance"` |  |
| job.specifications.send-new-relevant-task-notifications.schedule | string | `"33 5 * * *"` |  |
...
| job.specifications.send-new-relevant-task-notifications.args[0] | string | `"send_new_relevant_task_notifications"` |  |
...
| job.specifications.time-since.args[0] | string | `"time_since"` |  |
...
| job.specifications.cancel-external-sync-jobs.args[0] | string | `"cancel_external_sync_jobs"` |  |
...
| job.specifications.reindex-db.schedule | string | `"47 7 * * 6"` |  |
| job.specifications.reindex-db.niceness | int | `19` |  |
| job.specifications.reindex-db.command[0] | string | `"/bin/sde.sh"` |  |
| job.specifications.reindex-db.args[0] | string | `"reindex_db"` |  |
| job.specifications.reindex-db.args[1] | string | `"--only-reindex-if-invalid"` |  |
...
| minio.persistence.size | string | `"100Gi"` |  |
| minio.resources.requests.cpu | int | `1` |  |
| minio.resources.requests.memory | string | `"256Mi"` |  |
| minio.resources.limits.memory | string | `"8192Mi"` |  |
...
| minio-tenant.tenant.image.repository | string | `"repository.securitycompass.com/sde-docker-prod/minio/minio"` |  |
| minio-tenant.tenant.image.tag | string | `"RELEASE.2024-01-01T16-36-33Z"` |  |
| minio-tenant.tenant.imagePullSecret.name | string | `"security-compass-secret"` |  |
| minio-tenant.tenant.env[0].name | string | `"MINIO_BROWSER"` |  |
...
| minio-tenant.tenant.pools[0].size | string | `"100Gi"` |  |
| minio-tenant.tenant.certificate.requestAutoCert | bool | `false` |  |
| minio-tenant.tenant.buckets[0].name | string | `"backup"` |  |
| minio-tenant.tenant.configuration.name | string | `"sdelements-minio-env-configuration"` |  |
...
| networkPolicies.ingress-nginx-controller.podSelector.matchLabels."app.kubernetes.io/name" | string | `"ingress-nginx"` |  |
| networkPolicies.ingress-nginx-controller.ingress[0].selectors[0].ipBlock.cidr | string | `"0.0.0.0/0"` |  |
| networkPolicies.ingress-nginx-controller.ingress[0].ports[0].port | int | `80` |  |
| networkPolicies.ingress-nginx-controller.ingress[0].ports[1].port | int | `443` |  |
| networkPolicies.ingress-nginx-controller.ingress[1].selectors[0].podSelector.matchLabels."app.kubernetes.io/name" | string | `"prometheus"` |  |
| networkPolicies.ingress-nginx-controller.ingress[1].selectors[0].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"prometheus-stack"` |  |
| networkPolicies.ingress-nginx-controller.ingress[1].selectors[1].podSelector.matchLabels."app.kubernetes.io/name" | string | `"grafana-agent"` |  |
| networkPolicies.ingress-nginx-controller.ingress[1].selectors[1].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"grafana-agent-deployer"` |  |
| networkPolicies.ingress-nginx-controller.ingress[1].selectors[2].namespaceSelector.matchLabels."network.openshift.io/policy-group" | string | `"monitoring"` |  |
| networkPolicies.ingress-nginx-controller.ingress[1].ports[0].port | int | `10254` |  |
| networkPolicies.web.podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-web"` |  |
| networkPolicies.web.ingress[0].selectors[0].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"ingress"` |  |
| networkPolicies.web.ingress[0].selectors[0].podSelector.matchLabels.name | string | `"nginx-ingress-microk8s"` |  |
| networkPolicies.web.ingress[0].selectors[1].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"ingress-nginx"` |  |
| networkPolicies.web.ingress[0].selectors[1].podSelector.matchLabels."app.kubernetes.io/name" | string | `"ingress-nginx"` |  |
| networkPolicies.web.ingress[0].selectors[2].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"{{ .Release.Namespace }}"` |  |
| networkPolicies.web.ingress[0].selectors[2].podSelector.matchLabels."app.kubernetes.io/name" | string | `"ingress-nginx"` |  |
| networkPolicies.web.ingress[0].selectors[3].namespaceSelector.matchLabels."network.openshift.io/policy-group" | string | `"ingress"` |  |
| networkPolicies.web.ingress[0].selectors[4].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"istio-system"` |  |
| networkPolicies.web.ingress[0].ports[0].port | string | `"{{ index .Values \"web\" \"httpPort\" | int | default 9080 }}"` |  |
| networkPolicies.web.ingress[0].ports[1].port | string | `"{{ index .Values \"web\" \"httpsPort\" | int | default 9443 }}"` |  |
| networkPolicies.worker-10.podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-10"` |  |
| networkPolicies.worker-10.ingress[0].selectors[0].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-web"` |  |
| networkPolicies.worker-10.ingress[0].selectors[1].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-pas-plugin-worker"` |  |
| networkPolicies.worker-10.ingress[0].selectors[2].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-reporting"` |  |
| networkPolicies.worker-10.ingress[0].ports[0].port | string | `"{{ index .Values \"worker\" \"synchronous\" \"highPriority\" \"port\" | int | default 8080 }}"` |  |
| networkPolicies.worker-17.podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-17"` |  |
| networkPolicies.worker-17.ingress[0].selectors[0].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-web"` |  |
| networkPolicies.worker-17.ingress[0].selectors[1].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-pas-api"` |  |
| networkPolicies.worker-17.ingress[0].selectors[2].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-pas-plugin-worker"` |  |
| networkPolicies.worker-17.ingress[0].ports[0].port | string | `"{{ index .Values \"worker\" \"synchronous\" \"lowPriority\" \"port\" | int | default 8080 }}"` |  |
| networkPolicies.reporting.podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-reporting"` |  |
| networkPolicies.reporting.ingress[0].selectors[0].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-web"` |  |
| networkPolicies.reporting.ingress[0].ports[0].port | string | `"{{ index .Values \"reporting\" \"port\" | int | default 4433 }}"` |  |
| networkPolicies.minio.podSelector.matchLabels.app | string | `"minio"` |  |
| networkPolicies.minio.ingress[0].selectors[0].podSelector.matchLabels.app | string | `"minio-job"` |  |
| networkPolicies.minio.ingress[0].selectors[1].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-pas-api"` |  |
| networkPolicies.minio.ingress[0].selectors[2].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-pas-async-worker"` |  |
| networkPolicies.minio.ingress[0].selectors[3].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-pas-plugin-worker"` |  |
| networkPolicies.minio.ingress[0].selectors[4].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-10"` |  |
| networkPolicies.minio.ingress[0].selectors[5].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-17"` |  |
| networkPolicies.minio.ingress[0].selectors[6].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-15-sde-medium"` |  |
| networkPolicies.minio.ingress[0].selectors[7].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-database-backup"` |  |
| networkPolicies.minio.ingress[0].selectors[8].podSelector.matchLabels."app.kubernetes.io/name" | string | `"minio-operator"` |  |
| networkPolicies.minio.ingress[0].selectors[8].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"minio-operator"` |  |
| networkPolicies.minio.ingress[0].selectors[9].podSelector.matchLabels."app.kubernetes.io/name" | string | `"operator"` |  |
| networkPolicies.minio.ingress[0].selectors[9].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"minio-operator"` |  |
| networkPolicies.minio.ingress[0].selectors[10].podSelector.matchLabels."app.kubernetes.io/name" | string | `"operator"` |  |
| networkPolicies.minio.ingress[0].selectors[10].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"openshift-operators"` |  |
| networkPolicies.minio.ingress[0].ports[0].port | string | `"{{ index .Values \"minio\" \"minioAPIPort\" | default 9000 }}"` |  |
| networkPolicies.database.podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-database"` |  |
| networkPolicies.database.ingress[0].selectors[0].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-10"` |  |
| networkPolicies.database.ingress[0].selectors[1].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-17"` |  |
| networkPolicies.database.ingress[0].selectors[2].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-15-sde-medium"` |  |
...
| networkPolicies.database.ingress[0].selectors[16].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-send-new-relevant-task-notifications"` |  |
| networkPolicies.database.ingress[0].selectors[17].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-time-since"` |  |
| networkPolicies.database.ingress[0].selectors[18].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-trend-reporting"` |  |
| networkPolicies.database.ingress[0].selectors[19].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-reindex-db"` |  |
| networkPolicies.database.ingress[0].ports[0].port | string | `"{{ include \"sde.dbPort\" . }}"` |  |
| networkPolicies.database.ingress[1].selectors[0].podSelector.matchLabels."app.kubernetes.io/name" | string | `"prometheus"` |  |
| networkPolicies.database.ingress[1].selectors[0].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"prometheus-stack"` |  |
| networkPolicies.database.ingress[1].selectors[1].podSelector.matchLabels."app.kubernetes.io/name" | string | `"grafana-agent"` |  |
| networkPolicies.database.ingress[1].selectors[1].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"grafana-agent-deployer"` |  |
| networkPolicies.database.ingress[1].selectors[2].namespaceSelector.matchLabels."network.openshift.io/policy-group" | string | `"monitoring"` |  |
| networkPolicies.database.ingress[1].ports[0].port | string | `"{{ include \"sde.dbMetricsPort\" . }}"` |  |
| networkPolicies.broker.podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-broker"` |  |
| networkPolicies.broker.ingress[0].selectors[0].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-10"` |  |
| networkPolicies.broker.ingress[0].selectors[1].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-17"` |  |
| networkPolicies.broker.ingress[0].selectors[2].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-15-sde-medium"` |  |
| networkPolicies.broker.ingress[0].selectors[3].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-worker-18-sde-low"` |  |
| networkPolicies.broker.ingress[0].selectors[4].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-pas-async-worker"` |  |
| networkPolicies.broker.ingress[0].selectors[5].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-pas-plugin-worker"` |  |
| networkPolicies.broker.ingress[0].selectors[6].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-alm-hourly"` |  |
| networkPolicies.broker.ingress[0].selectors[7].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-alm-daily"` |  |
| networkPolicies.broker.ingress[0].selectors[8].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-alm-weekly"` |  |
| networkPolicies.broker.ingress[0].selectors[9].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-alm-monthly"` |  |
| networkPolicies.broker.ingress[0].selectors[10].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-cancel-external-sync-jobs"` |  |
| networkPolicies.broker.ingress[0].selectors[11].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-database-backup"` |  |
| networkPolicies.broker.ingress[0].selectors[12].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-clear-expired-sessions"` |  |
| networkPolicies.broker.ingress[0].selectors[13].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-refresh-task-relevance"` |  |
| networkPolicies.broker.ingress[0].selectors[14].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-metrics"` |  |
| networkPolicies.broker.ingress[0].selectors[15].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-send-new-relevant-task-notifications"` |  |
| networkPolicies.broker.ingress[0].selectors[16].podSelector.matchLabels.app | string | `"{{ include \"library.trimmedName\" . | trunc 10 }}-job-time-since"` |  |
| networkPolicies.broker.ingress[0].ports[0].port | string | `"{{ index .Values \"port\" | int | default 5672 }}"` |  |
| networkPolicies.broker.ingress[1].selectors[0].podSelector.matchLabels.name | string | `"{{ include \"library.trimmedName\" . }}-pas-api"` |  |
| networkPolicies.broker.ingress[1].ports[0].port | string | `"{{ index .Values \"port\" | int | default 5672 }}"` |  |
| networkPolicies.broker.ingress[1].ports[1].port | string | `"{{ index .Values \"managementPort\" | int | default 15672 }}"` |  |
| networkPolicies.broker.ingress[2].selectors[0].podSelector.matchLabels."app.kubernetes.io/name" | string | `"prometheus"` |  |
| networkPolicies.broker.ingress[2].selectors[0].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"prometheus-stack"` |  |
| networkPolicies.broker.ingress[2].selectors[1].podSelector.matchLabels."app.kubernetes.io/name" | string | `"grafana-agent"` |  |
| networkPolicies.broker.ingress[2].selectors[1].namespaceSelector.matchLabels."kubernetes.io/metadata.name" | string | `"grafana-agent-deployer"` |  |
| networkPolicies.broker.ingress[2].selectors[2].namespaceSelector.matchLabels."network.openshift.io/policy-group" | string | `"monitoring"` |  |
| networkPolicies.broker.ingress[2].ports[0].port | int | `9419` |  |
...
| clusterDomain | string | `"cluster.local"` |  |
| image.repository | string | `"quay.io/minio/minio"` |  |
| image.tag | string | `"RELEASE.2024-04-18T19-09-19Z"` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| imagePullSecrets | list | `[]` |  |
| mcImage.repository | string | `"quay.io/minio/mc"` |  |
| mcImage.tag | string | `"RELEASE.2024-04-18T16-45-29Z"` |  |
| mcImage.pullPolicy | string | `"IfNotPresent"` |  |
| mode | string | `"distributed"` |  |
| additionalLabels | object | `{}` |  |
| additionalAnnotations | object | `{}` |  |
...
| Repository | Name | Version |
|------------|------|---------|
| file://../mock_sde | mock-sde | 0.0.1 |
| https://repository.securitycompass.com/artifactory/sde-helm-dev | pas-api | 2.0.6 |
| https://repository.securitycompass.com/artifactory/sde-helm-dev | pas-async-worker | 2.0.6 |
| https://repository.securitycompass.com/artifactory/sde-helm-dev | pas-frontend | 2.0.6 |
| https://repository.securitycompass.com/artifactory/sde-helm-dev | pas-plugin-worker | 2.0.6 |
| https://repository.securitycompass.com/artifactory/sde-helm-dev | sc-library | 1.1.4 |
...
| global.imagePullPolicy | string | `"IfNotPresent"` |  |
| global.pas.enabled | bool | `false` |  |
| global.pas.databasePrefix | string | `"pas"` |  |
| global.pas.database.user | string | `"pas"` |  |
| global.pas.database.passwordSecretKey | string | `"PAS_DATABASE_PASSWORD"` |  |
| global.pas.broker.user | string | `"pas"` |  |
| global.pas.broker.passwordSecretKey | string | `"PAS_BROKER_PASSWORD"` |  |
| global.pas.datastore | object | `{}` |  |
| global.pas.baseUrl | string | `"/pas"` |  |
| global.pas.enableCustomPlugins | bool | `true` |  |
| global.pas.sharedStorage | object | `{}` |  |
| global.sharedStorage | object | `{}` |  |
| global.datastore | object | `{}` |  |
| global.thirdPartyCACertificates.enabled | bool | `false` |  |
| pas-api.replicas | int | `1` |  |
| pas-api.useBrokerSubchart | bool | `false` |  |
| pas-api.useDatabaseSubchart | bool | `false` |  |
| pas-api.useDatastoreSubchart | bool | `false` |  |
| pas-api.minio.enabled | bool | `false` |  |
| pas-api.includeSDESecret | bool | `false` |  |
| pas-api.sde.jwtSecret | string | `"s3cr3tk3y"` |  |
| pas-api.sde.broker | object | `{}` |  |
| pas-api.admin.database | object | `{}` |  |
| pas-api.admin.broker | object | `{}` |  |
| pas-api.sharedStorage | object | `{}` |  |
| pas-plugin-worker.replicas | int | `1` |  |
| pas-plugin-worker.useBrokerSubchart | bool | `false` |  |
| pas-plugin-worker.minio.enabled | bool | `false` |  |
| pas-plugin-worker.broker.secretName | string | `"pas-secrets"` |  |
| pas-plugin-worker.sharedStorage | object | `{}` |  |
| pas-async-worker.replicas | int | `1` |  |
| pas-async-worker.useBrokerSubchart | bool | `false` |  |
| pas-async-worker.useDatabaseSubchart | bool | `false` |  |
| pas-async-worker.minio.enabled | bool | `false` |  |
| pas-async-worker.broker.secretName | string | `"pas-secrets"` |  |
| pas-async-worker.database.secretName | string | `"pas-secrets"` |  |
| pas-async-worker.sharedStorage | object | `{}` |  |
| pas-async-worker.resultBackend | string | `"rpc://"` |  |
| pas-frontend.replicas | int | `1` |  |
| mock-sde.secretKey | string | `"s3cr3tk3y"` |  |
| useMockSDE | bool | `false` |  |
| includeIngress | bool | `false` |  |
