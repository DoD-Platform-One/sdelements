...
{{- $root := (get . "root") -}}
{{- $dot := (get . "dot") -}}
{{- $secretName := default (default (default "broker" (index $root.Values "rabbitmq" "auth" "existingPasswordSecret")) $root.Values.global.pas.broker.secretName) $dot.broker.secretName -}}
...
{{- define "pas-async-worker.broker.resultBackendKey" -}}
{{- $root := (get . "root") -}}
{{- $dot := (get . "dot") -}}
